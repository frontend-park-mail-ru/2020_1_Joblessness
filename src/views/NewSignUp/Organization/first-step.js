...
import {uuid, currentSession, withForm, requestManager} from '../../../ulils';
...
FirstStep = withForm(FirstStep, {
  login: {
    ...
    required: true,
    validator: isLogin,
    warnMessage: 'Имя пользователя состоит из латинских букв и цифр, ' +
        'а также "_" и "." Длина логина не менее 6.',
  },
  password: {
    id: uuid(),
    required: true,
    validator: isPassword,
    warnMessage: 'Пароль состоит из латинских букв и цифр, длина не менее 8. ' +
        'Должен содержать хотя бы 1 цифру и Заглавную букву.',
  },
},
{
  id: uuid(),
