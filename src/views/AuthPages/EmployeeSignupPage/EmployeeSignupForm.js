...
export class EmployeeSignupForm {

    constructor() {
        this.textInputNames = ['first-name',
                               'second-name'];
    ...
    validate() {
        ...
        this.textInputNames.forEach(inputName => {
            const inputBlock = document.querySelector(`.employee-signup-form-${inputName}`);
    ...
    addSubmit() {
        document.querySelector('.employee-signup-form-submit').addEventListener('click', (e) => {
            e.preventDefault();
